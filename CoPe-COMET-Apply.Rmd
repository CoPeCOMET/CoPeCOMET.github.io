...
* Applicants are asked to provide 4 things:
  ...
  2. a 1-page  ‘Quad Chart’ of your project idea with 4 panels ([See the FAQ for an example](https://copecomet.github.io/CoPe-COMET-FAQ.html)): 
  ...
  4. a short (1-2 page) Curriculum Vitae (with links to website, GitHub handle, Twitter handle, etc.)
