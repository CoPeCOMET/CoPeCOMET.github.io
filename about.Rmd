...
Each event is likely to be heavy on computation, and our intention is for all code written at the event to be open source, put on github, and given a DOI (by the end of the event). A final 'report out' will allow each group to present what they accomplished at the end of the 72 hours, and groups will also submit a report/working apper [EarthArXiv](https://eartharxiv.org). Our intention is for these open deliverables to be the seeds of future research between participants and the wider CoPe Community.

We will soon be soliciting applications for each 72 hr event. Check out the 'Apply!' tab for the short application procedure. 
