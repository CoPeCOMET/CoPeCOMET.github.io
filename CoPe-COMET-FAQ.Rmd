...
* **What does the Quad Chart / 'Project Pitch' look like?**
    + Here is an example (and instructions) from [NASA](https://esto.nasa.gov/files/EntryQuad_instructions_template.ppt). We prefer you use the Quadrant headers from the example below — 
